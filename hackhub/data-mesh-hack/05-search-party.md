...
- [Cognitive Search: Add vector fields to a search index](/azure/search/vector-search-how-to-create-index)
- [Cognitive Search: Create and use embeddings for search queries and documents](/azure/search/vector-search-how-to-generate-embeddings)
- [Cognitive Search: Semantic search in Azure AI Search](/azure/search/semantic-search-overview)
- [Cognitive Search: Vector search within Azure AI Search](/azure/search/vector-search-overview)
